...
public final class DMBeanUtils2 {
  private static final Logger logger = Logger.getLogger(DMBeanUtils2.class.getName());
  ...
  public static MBeanOperationInfo[] getOps2(OpMetadataList opList) {
    MBeanOperationInfo[] ops = null;
    if (opList == null || opList.getOpMetadatList() == null) {
      logger.log(Level.WARNING, "No operation is configured");
      return ops;
